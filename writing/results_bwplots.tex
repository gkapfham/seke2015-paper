...
Figure~\ref{fig:datas} reveals the Random and Random Defaults generators took the most amount of time by a substantial
margin. A less pronounced difference between the remaining generators can be observed, with default values consistently
outperforming the use of random values at search restart.
