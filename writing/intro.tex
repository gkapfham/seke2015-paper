...
Since this approach is fully automated, it enabled a comprehensive study that also suggested the worst-case time
...
applicable to a wide range of approaches that use heuristic search. In summary, this paper's important contributions
include:
