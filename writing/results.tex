...
\textbf{Results} Our experiments reveal that for the number of \texttt{Uniques, NotNulls,
...
\textbf{Threats to Validity} Our technique for doubling the number of check constraints on the schema
