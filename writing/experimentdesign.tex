...
ones (i.e., ANCC, AICC, and AUCC), and ``strong'' criteria (e.g., CondAICC and ClauseAICC). More details about each
...
that the ratio converged to the correct value with this configuration.  We set $\mathit{minimum}$ to $20$ after observing that
...
resources.  As a solution, we ran the experiments on a high-performance computing (HPC) cluster containing 195
