...
\centering
  \centering
  \includegraphics[width=1.0\linewidth]{diagrams/AllTree.pdf}

  \caption{Tree model using all variables to predict runtime in minutes.  \vspace{-.15in}} \label{fig:atree}
